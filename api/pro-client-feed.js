  ...
  try {
    ...
    return jsonResponse(request, {
      ...
      executor: {
        ...
        minScore: Number(state.config?.bitgetMinScore || state.config?.minScore || 12),
        strictRegimeMinScore: Number(state.config?.strictRegimeMinScore || state.config?.bitgetMinScore || 12),
