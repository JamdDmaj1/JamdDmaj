import { decodeCreatorVesting, decodeToken2022Account, normalizePublicKey } from "./solana-account-codecs.js";
const TOKEN_2022_PROGRAM_ID = "TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb";

export const JAMD_DEVNET = Object.freeze({
  mint: "3hGv2JJ8Hfktw5LMPoSN6R4enoAAZMPvPtS3TcwgGV61",
  policy: "HpnJiFUavzPGi3ogKqLHRqvaY1bMBamhgiBu5trqGPyz",
  vesting: "874KTGhKo3FyeDTvenEGQrgKskHkTJDjynEU3dRgCip2",
  vault: "DwjWRn3aoupJHJRai8PhVBwDN8aXoufix38KmJk1cMcu",
  // This mint and its vesting account belong to the immutable version-1
  // program. A later Fair Launch program must never rewrite this binding.
...
export async function readJamdDevnetBalance(owner, fetchImpl = fetch) {
  ...
  return {
    ...
    mint: JAMD_DEVNET.mint, name: "JamdDmaj", symbol: "JAMD", decimals: 9,
