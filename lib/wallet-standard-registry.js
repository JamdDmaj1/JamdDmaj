const REGISTRY_KEY = Symbol.for("jamddmaj.wallet-standard.registry");

export function getWalletRegistry() {
  if (globalThis[REGISTRY_KEY]) return globalThis[REGISTRY_KEY];
  const registry = createWalletRegistry(typeof window === "undefined" ? null : window);
  Object.defineProperty(globalThis, REGISTRY_KEY, { value: registry, configurable: true });
  return registry;
}
