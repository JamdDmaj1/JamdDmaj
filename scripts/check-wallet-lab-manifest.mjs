...
const previews=manifests('android/app/build/intermediates/merged_manifests/walletPreview');
if(previews.length!==1)throw new Error('Missing integrated preview manifest');
const preview=readFileSync(previews[0],'utf8');
if(!preview.includes('package="com.jamddmaj.ai.walletpreview"'))throw new Error('Preview must not replace production');
