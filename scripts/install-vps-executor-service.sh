...
JAMDDMAJ_MAX_LIVE_MARGIN_USD=35
JAMDDMAJ_FIXED_MARGIN_USD=10
JAMDDMAJ_AUTO_RISK=true
JAMDDMAJ_AUTO_RISK_PER_TRADE_PERCENT=3
JAMDDMAJ_AUTO_RISK_MIN_MARGIN_USD=5
JAMDDMAJ_AUTO_RISK_RESERVE_PERCENT=25
JAMDDMAJ_MIN_LIVE_SCORE=10
JAMDDMAJ_STRICT_REGIME_MIN_SCORE=10
JAMDDMAJ_MIN_LIVE_LIQUIDITY_USD=0
JAMDDMAJ_ALLOW_MEME_LIVE=true
...
JAMDDMAJ_MAX_DAILY_LOSS_USD=100
JAMDDMAJ_MAX_DAILY_LOSS_PERCENT=50
JAMDDMAJ_MAX_CONSECUTIVE_LOSSES=10
JAMDDMAJ_MAX_TRADES_PER_DAY=100
JAMDDMAJ_LIVE_RISK_BALANCE_USD=1000
JAMDDMAJ_RECENT_OPEN_MINUTES=120
JAMDDMAJ_MAX_EXECUTION_SIGNAL_AGE_MINUTES=30
ENV
  chmod 600 "$ENV_FILE"
