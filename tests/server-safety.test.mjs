...
test("wallet login UI never requests custody secrets or enables transactions", () => {
  ...
  const androidActivity = readFileSync(new URL("../android/app/src/main/java/com/jamddmaj/ai/MainActivity.java", import.meta.url), "utf8");
  const walletPlugin = readFileSync(new URL("../android/app/src/main/java/com/jamddmaj/ai/ExternalWalletPlugin.java", import.meta.url), "utf8");
